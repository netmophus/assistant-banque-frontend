    ...
    try {
      ...
      if (orgId) {
        try {
          ...
          const activeLicense = licensesRes.find((l: License) => l.status === 'active') || null;
          setLicense(activeLicense);
          setHasActiveLicense(!!activeLicense);
        } catch (err) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
      ...
      <ScrollReveal direction="down" delay={0}>
        <div className="relative rounded-3xl overflow-hidden mb-6"
          style={{ borderTop: '2px solid rgba(27,58,140,0.4)', borderRight: '2px solid rgba(27,58,140,0.4)', borderBottom: '2px solid rgba(27,58,140,0.4)', borderLeft: '4px solid #1B3A8C', background: 'linear-gradient(135deg, #070E28 0%, #0F1E48 60%, #0A1434 100%)', boxShadow: '0 0 32px rgba(27,58,140,0.15)' }}>
          ...
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#1B3A8C]/60 to-transparent" />
          ...
          <div className="relative z-10 p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center gap-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-semibold text-white/40 uppercase tracking-wider">Accès & Rôles</span>
              </div>
              <h1 className="text-2xl sm:text-3xl font-black text-white mb-1">
                Permissions des <span style={{ background: 'linear-gradient(90deg, #C9A84C, #e8c97a)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Onglets</span>
              </h1>
              <p className="text-sm text-white/55 max-w-xl leading-relaxed">
                Configurez les permissions d'accès aux différents onglets pour vos utilisateurs, départements et services.
              </p>
            </div>
            ...
            <div className="flex gap-2 flex-wrap sm:flex-nowrap">
              {[
                { label: 'Utilisateurs', color: '#1B3A8C' },
                { label: 'Départements', color: '#C9A84C' },
                { label: 'Services', color: '#059669' },
              ].map(b => (
          ...
          <div className="mb-6 p-5 rounded-2xl flex items-start gap-4"
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-white/55 mb-3">
                Une licence active est nécessaire pour configurer les permissions des onglets.
              </p>
              <button onClick={() => router.push('/m2/dashboard')}
        ...
        <div className="rounded-3xl"
          ...
          {hasActiveLicense ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
              ...
              <p className="text-white font-bold mb-1">Licence active requise</p>
              <p className="text-white/45 text-sm">Veuillez activer une licence pour accéder à cette fonctionnalité.</p>
            </div>
          )}
        </div>
      </ScrollReveal>
