...
export default function PCBSettingsPage() {
          ...
          <div className="relative z-10 p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center gap-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-semibold text-white/40 uppercase tracking-wider">États Financiers</span>
              </div>
              <h1 className="text-2xl sm:text-3xl font-black text-white mb-1">
                PCB &amp; <span style={{ background: 'linear-gradient(90deg, #C9A84C, #e8c97a)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Ratios Bancaires</span>
              </h1>
              <p className="text-sm text-white/55 max-w-xl leading-relaxed">
                Configurez les paramètres pour la génération des états financiers PCB UEMOA et l'analyse des ratios.
              </p>
            </div>
            ...
            <div className="flex gap-2 flex-wrap sm:flex-nowrap">
              {[
                ...
                { label: 'Ratios BCEAO', color: '#1B3A8C' },
                { label: 'CB-UMOA', color: '#059669' },
              ].map(b => (
